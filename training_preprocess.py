...
#csv file features
#ip, app, channel, device, os, click_time, attributed_time, is_attributed

def pre_process_train(filename : str):
    ...
    dataset = pd.read_csv(filename, dtype=dtypes, parse_dates=['click_time']) 
    ...
    dataset.drop(columns=['click_time', 'attributed_time'], inplace=True)
