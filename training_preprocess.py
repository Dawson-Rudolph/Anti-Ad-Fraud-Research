...
# wraped the data preprocessing to a function so it can be called in the ML models
def preprocess_data():
    ...
    # Drop the specified columns in-place to save memory, ignore errors if columns don't exist
    dataset.drop(columns=['click_time', 'attributed_time'], inplace=True, errors='ignore')
    return dataset
